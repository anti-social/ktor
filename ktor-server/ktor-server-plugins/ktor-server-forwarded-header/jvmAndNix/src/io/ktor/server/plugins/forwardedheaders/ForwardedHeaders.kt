...
public class ForwardedHeadersConfig {
    public var forwardedHeadersHandler: (MutableOriginConnectionPoint, List<ForwardedHeaderValue>) -> Unit =
        { _, _ -> }
...
public val ForwardedHeaders: ApplicationPlugin<Application, ForwardedHeadersConfig, PluginInstance> =
    createApplicationPlugin("ForwardedHeaders", createConfiguration = { ForwardedHeadersConfig() }) {
        ...
        onCall { call ->
            val forwardedHeaders = call.request.forwardedHeaders() ?: return@onCall
            call.attributes.put(forwardedParsedKey, forwardedHeaders)
